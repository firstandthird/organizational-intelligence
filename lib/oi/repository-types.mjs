 ...
 * @property {string[]} [embeddedReferences] ids/paths expanded during fetch
 * @property {string[]} [embeddedMissing] unresolved embed targets from fetch
 * @property {string[]} [embeddedCycles] cyclic embed targets detected during fetch
 */
